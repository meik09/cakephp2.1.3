...
?>
<?php echo $this->Form->create('VmoSystem', array('url' => '/systems/index', 'type' => 'file', 'inputDefaults' => array('label' => false, 'div' => false, 'legend' => false))); ?>
<div class="content_title">【　システム管理　】</div>
<table class="system_import_tbl1">
	...
	<?php } ?>
    <?php if (isset($sameStudentFile)) { ?>
	<tr>
		<th class="system_import_th1">在籍者情報の確認：</th>
		<td class="system_import_td1">
			<?php echo $this->Html->link($sameStudentFile, '/files/'.$sameStudentFile); ?>
			&nbsp;←&nbsp;ダウンロードをされる場合には、リンク上で右クリックをして｢対象をファイルに保存...｣を選択して下さい。
		</td>
	</tr>    
    <?php } ?>
