...
?>
<?php echo $this->Form->create('Student', array('url' => '/students/add', 'type' => 'POST', 'inputDefaults' => array('label' => false, 'div' => false, 'legend' => false, 'error' => false))); ?>
...
<table class="student_input_tbl1">
    <tr>
        ...
        <td colspan="3" class="student_input_td1_3"><?php echo $this->Form->input('personal_id', array('type' => 'text', 'class' => 'number', 'maxlength' => '10')); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3" class="student_input_td1_3"><?php echo $this->Form->input('guarantor_tel', array('type' => 'text', 'class' => 'employment')); ?></td>
    </tr>
    <tr>
            ...
            <table id="supportPriceTbl">
                ...
                <tbody>
                    ...
                    foreach ($this->data['SupportPrice'] as $key => $rec) {
                        if ($key == 99) continue;
                        ?>
                        <tr id="supportPrice<?php echo $supportNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display:none;"'; ?>>
                            <td>
...
<span id="CollegeHistoryList">
    ...
    foreach ($this->data['CollegeHistory'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="CollegeHistory<?php echo $collegeHistoryNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($collegeHistoryNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl2">
                ...
                <tr>
                    ...
                    <td class="student_input_td2_1"><?php echo $this->Form->input('CollegeHistory.' . $collegeHistoryNum . '.student_status', array('type' => 'text', 'class' => 'name')); ?></td>
                </tr>
                <tr>
    ...
    <span id="CollegeHistory99" style="display: none;">
        ...
        <table class="student_input_tbl2">
                ...
                <tr>
                    <th class="student_input_th2_1">*在籍状態区分：</th>
                    <td class="student_input_td2_1"><?php echo $this->Form->input('CollegeHistory.99.student_status', array('type' => 'text', 'class' => 'name')); ?></td>
                </tr>
                <tr>
                    <th class="student_input_th2_1">*学部・学科・専攻名：</th>
...
<span id="CollegeSeminarList">
    ...
    foreach ($this->data['CollegeSeminar'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="CollegeSeminar<?php echo $collegeSeminarNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($collegeSeminarNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl3">
                <tr>
                    ...
                    <td class="student_input_td3_1">
                        ...
                        <?php echo $this->Form->input('CollegeSeminar.' . $collegeSeminarNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_COLLEGE)); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td class="student_input_td3_1"><?php echo $this->Form->input('CollegeSeminar.' . $collegeSeminarNum . '.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
                </tr>
                <tr>
    ...
    <span id="CollegeSeminar99" style="display: none;">
        ...
        <table class="student_input_tbl3">
            ...
            <tr>
                <th class="student_input_th3_1">履修年度：</th>
                <td class="student_input_td3_1"><?php echo $this->Form->input('CollegeSeminar.99.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
            </tr>
            <tr>
                <th class="student_input_th3_1">ゼミ成績：</th>
...
<span id="CollegeClubList">
    ...
    foreach ($this->data['CollegeClub'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="CollegeClub<?php echo $collegeClubNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($collegeClubNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl4">
                <tr>
                    ...
                    <td class="student_input_td4_1">
                        ...
                        <?php echo $this->Form->input('CollegeClub.' . $collegeClubNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_COLLEGE)); ?>
                    </td>
...
<span id="HighHistoryList">
    ...
    foreach ($this->data['HighHistory'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="HighHistory<?php echo $highHistoryNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($highHistoryNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl2">
                <tr>
                    <th class="student_input_th2_1">出身校：</th>
                    <td class="student_input_td2_1">
...
<span id="HighSeminarList">
    ...
    foreach ($this->data['HighSeminar'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="HighSeminar<?php echo $highSeminarNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($highSeminarNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl3">
                <tr>
                    ...
                    <td class="student_input_td3_1">
                        ...
                        <?php echo $this->Form->input('HighSeminar.' . $highSeminarNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_HIGH)); ?>
                    </td>
                    <td class="student_input_td3_2" rowspan="3">
                ...
                <tr>
                    <th class="student_input_th3_1">履修年度：</th>
                    <td class="student_input_td3_1"><?php echo $this->Form->input('HighSeminar.' . $highSeminarNum . '.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
                </tr>
                <tr>
                    <th class="student_input_th3_1">ゼミ成績：</th>
    ...
    <span id="HighSeminar99" style="display: none;">
        ...
        <table class="student_input_tbl3">
            ...
            <tr>
                <th class="student_input_th3_1">履修年度：</th>
                <td class="student_input_td3_1"><?php echo $this->Form->input('HighSeminar.99.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
            </tr>
            <tr>
                <th class="student_input_th3_1">ゼミ成績：</th>
...
<span id="HighClubList">
    ...
    foreach ($this->data['HighClub'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="HighClub<?php echo $highClubNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($highClubNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl4">
                <tr>
                    <th class="student_input_th4_1">サークル分類名：</th>
                    <td class="student_input_td4_1">
                        ...
                        <?php echo $this->Form->input('HighClub.' . $highClubNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_HIGH)); ?>
                    </td>
                    <td class="student_input_td4_2" rowspan="5">
...
<span id="JuniorHistoryList">
    ...
    foreach ($this->data['JuniorHistory'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="JuniorHistory<?php echo $juniorHistoryNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($juniorHistoryNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl2">
                <tr>
                    <th class="student_input_th2_1">出身校：</th>
                    <td class="student_input_td2_1">
...
<span id="JuniorSeminarList">
    ...
    foreach ($this->data['JuniorSeminar'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="JuniorSeminar<?php echo $juniorSeminarNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($juniorSeminarNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl3">
                <tr>
                    <th class="student_input_th3_1">*担当教員名：</th>
                    <td class="student_input_td3_1">
                        ...
                        <?php echo $this->Form->input('JuniorSeminar.' . $juniorSeminarNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_JUNIOR)); ?>
                    </td>
                    <td class="student_input_td3_2" rowspan="3">
                ...
                <tr>
                    <th class="student_input_th3_1">履修年度：</th>
                    <td class="student_input_td3_1"><?php echo $this->Form->input('JuniorSeminar.' . $juniorSeminarNum . '.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
                </tr>
                <tr>
                    <th class="student_input_th3_1">ゼミ成績：</th>
    ...
    <span id="JuniorSeminar99" style="display: none;">
        ...
        <table class="student_input_tbl3">
            ...
            <tr>
                <th class="student_input_th3_1">履修年度：</th>
                <td class="student_input_td3_1"><?php echo $this->Form->input('JuniorSeminar.99.completion_year', array('type' => 'text', 'class' => 'date')); ?>年度</td>
            </tr>
            <tr>
                <th class="student_input_th3_1">ゼミ成績：</th>
...
<span id="JuniorClubList">
    ...
    foreach ($this->data['JuniorClub'] as $key => $rec) {
        if ($key == 99)
            continue;
        ?>
        <span id="JuniorClub<?php echo $juniorClubNum; ?>" <?php if ($rec['delete_flg'] == 1) echo 'style="display: none;"'; ?>>
            <?php if ($juniorClubNum != 0 && $rec['delete_flg'] != 1) echo '<div class="separator_div">&nbsp;</div>'; ?>
            <table class="student_input_tbl4">
                <tr>
                    <th class="student_input_th4_1">サークル分類名：</th>
                    <td class="student_input_td4_1">
                        ...
                        <?php echo $this->Form->input('JuniorClub.' . $juniorClubNum . '.student_type', array('type' => 'hidden', 'value' => Resource::STUDENT_TYPE_JUNIOR)); ?>
                    </td>
                    <td class="student_input_td4_2" rowspan="5">
...
<div class="button_block">
    <?php echo $this->Form->submit('/img/students/registBtn.png', array('div' => false)); ?>
