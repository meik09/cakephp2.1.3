...
//サイト専用のコンフィグロード
//defineの羅列の形式を読み込むために requireを使用する
require __DIR__ . "/saints_define.php";
...
{
  case STAGING_DOMAIN:
  case "www.".STAGING_DOMAIN:
    if (file_exists(CONFIG . 'app_staging.php')) {
        Configure::load('app_staging', 'default');
    }
    break;

  case PRODUCTION_DOMAIN:
  case "www.".PRODUCTION_DOMAIN:
    if (file_exists(CONFIG . 'app_production.php')) {
